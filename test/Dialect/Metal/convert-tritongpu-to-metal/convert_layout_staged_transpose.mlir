...
// producer cone is NOT self-contained. That forces `normalizeBlockedDivergentCvts`
// to bail (a self-contained cone would instead collapse the cvt to a direct
// gather/scatter — see convert_layout_rank2_transpose_normalized.mlir),
// keeping this fixture's coverage on the staged-transpose fallback body.
