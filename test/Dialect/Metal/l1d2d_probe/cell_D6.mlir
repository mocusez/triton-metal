// L1d2d cell D6: B1=non-identity, B2=barrier-present, B3=in-warp (16 threads).
// 4x4 transpose: idx = (lid%4)*4 + lid/4.
// Expected: likely FAIL if Apple's race is per-warp-shuffle; PASS otherwise.

module {
  metal.module {
    metal.kernel cell_D6 address_space_device [true, true] {
