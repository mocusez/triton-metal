...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:80", "ttg.threads-per-warp" = 32 : i32} {
  metal.module {
    metal.kernel fa_kernel address_space_device [true, true, true, true, true, true, true] {
    ^bb0(%q: !metal.memref<? x f32>, %k: !metal.memref<? x f32>, %v: !metal.memref<? x f32>, %o: !metal.memref<? x f32>, %n: !metal.memref<? x ui32>, %dm: !metal.memref<? x ui32>, %h: !metal.memref<? x ui32>):
      metal.flash_attention %q, %k, %v, %o, %n, %dm, %h {bm = 32 : i64, bn = 32 : i64, bd = 16 : i64} : !metal.memref<? x f32>, !metal.memref<? x f32>, !metal.memref<? x f32>, !metal.memref<? x f32>, !metal.memref<? x ui32>, !metal.memref<? x ui32>, !metal.memref<? x ui32>
      metal.return
    }
    metal.module_end
  }
...
// CHECK: device uint32_t *v6 {{\[\[}}buffer(6)]]
...
// CHECK: float scaler = exp(m_old - m_new);
// CHECK: exp(_fa_sbuf[q*32u + kk]*_fa_scale - m_new)
