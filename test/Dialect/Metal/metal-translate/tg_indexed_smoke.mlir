...
//
// Session L1d Phase A (`.omc/specs/deep-interview-leet-triton-l1d-phase-a-staged-transpose-infra.md`):
...
// `.omc/specs/deep-interview-leet-triton-l1d2b-masked-cvt-inline-barrier.md`.
// MSL: float v{{[0-9]+}} = v{{[0-9]+}}[{{[0-9]+}}];
// MSL: threadgroup_barrier(mem_flags::mem_threadgroup);
// MSL: v{{[0-9]+}}[{{[0-9]+}}] = v{{[0-9]+}};
// MSL: return;
