...
Runs the verbatim `python/test/unit/fixtures/metal_leet/medium-batch_normalization.py` kernel: a
...
# Verbatim copy of python/test/unit/fixtures/metal_leet/medium-batch_normalization.py.
@triton.jit
