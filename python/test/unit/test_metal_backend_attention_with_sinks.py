...
The verbatim `python/test/unit/fixtures/metal_leet/medium-attention_with_sinks.py` kernel: causal
...
# Verbatim copy of python/test/unit/fixtures/metal_leet/medium-attention_with_sinks.py.
@triton.jit
