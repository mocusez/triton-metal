...
Runs the verbatim `python/test/unit/fixtures/metal_leet/medium-grpo_surrogate_loss.py` kernel. The single
...
# Verbatim copy of python/test/unit/fixtures/metal_leet/medium-grpo_surrogate_loss.py.
@triton.jit
