...
Runs the verbatim `python/test/unit/fixtures/metal_leet/medium-matrix_power.py` kernel: a tiled `tt.dot`
...
# Verbatim copy of python/test/unit/fixtures/metal_leet/medium-matrix_power.py.
@triton.jit
