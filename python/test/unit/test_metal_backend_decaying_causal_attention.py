...
The verbatim `python/test/unit/fixtures/metal_leet/medium-decaying_causal_attention.py` kernel: causal
...
# Verbatim copy of python/test/unit/fixtures/metal_leet/medium-decaying_causal_attention.py.
@triton.jit
