...
The verbatim `python/test/unit/fixtures/metal_leet/hard-sliding_window_self_attention.py` kernel: the
...
# Verbatim copy of python/test/unit/fixtures/metal_leet/hard-sliding_window_self_attention.py.
@triton.jit
def attention(
    Q, K, V,
    output,
